...
#include "circom.hpp"
#include "calcwit.hpp"
void Product_0_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Product_0_run(uint ctx_index,Circom_CalcWit* ctx);
...
ctx->componentMemory[coffset].templateName = "Product";
...
Product_0_create(1,0,ctx,"main",0);
Product_0_run(0,ctx);
}
